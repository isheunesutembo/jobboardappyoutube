...
class _$PaginationStateImpl<T> implements _PaginationState<T> {
  ...
  @override
  String toString() {
    return 'PaginationState<$T>(data: $data, isLoadingMore: $isLoadingMore, hasNext: $hasNext, isLoading: $isLoading, error: $error, currentPage: $currentPage)';
  }
